...
public class DatabaseContract {
    ...
    private static final String AUTHORITY = "com.fando.picodiploma.moviecatalogue_4";
    ...
    public static final class FavouriteColumnsMovie implements BaseColumns {
        static final String TABLE_NAME_MOV = "fav_movie";
    ...
    public static final class FavouriteColumnsTV implements BaseColumns {
        static final String TABLE_NAME_TV = "fav_tv";
