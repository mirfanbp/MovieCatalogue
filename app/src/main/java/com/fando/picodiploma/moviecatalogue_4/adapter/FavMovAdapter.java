...
public class FavMovAdapter extends RecyclerView.Adapter<FavMovAdapter.FavMovHolder> {
    ...
    public void onBindViewHolder(@NonNull FavMovHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent detailFavMovieIntent = new Intent(context, DetailMovieActivity.class);
                detailFavMovieIntent.putExtra(DetailMovieActivity.EXTRA_MOVIE, movies);
                context.startActivity(detailFavMovieIntent);
            }
        });
    }
    ...
    public void searchFavourite(ArrayList<MoviesItem> favouriteList) {
        moviesFavData.addAll(favouriteList);
